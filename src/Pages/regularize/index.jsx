...
//     // Set the selected record and open the popup directly for approval
...
//         dispatch(fetchRegularizeList(currentPage, pageSize));
//       })
//     );
//   };
...
//   // Columns adjusted to include Serial No. and remove User ID
//   const columns = [
//     {
//       title: "Serial No.",
//       key: "serial_no",
...
//           <Button
//             type="primary"
//             onClick={() => handleApprove(record)} // Trigger approve action
//             style={{ marginRight: 8 }}
//           >
//             Approve
//           </Button>
...
//       <CommonPopup
//         title={<div>Regularize For {selectedRecord?.user_id}</div>}
//         isModalOpen={isModalOpen}
//         okText="Submit"
//         handleOk={handleOk} // Now the handleOk method triggers the approval
